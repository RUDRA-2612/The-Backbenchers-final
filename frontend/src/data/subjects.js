...
export const masterSubjects = {
  year1: {
    ...
    semesters: {
      1: [
        { code: 'CS1139', name: 'Programming 1 (Python)', icon: Terminal, desc: 'Introductory programming, control flow, functions, lists, and file handling.' },
      ...
      2: [
        { code: 'CS1135', name: 'Programming 2 (C)', icon: Code, desc: 'Advanced programming in C, pointers, memory management, and data structures.' },
  ...
  year2: {
    ...
    semesters: {
      3: [
        { code: 'CS1131', name: 'Data Structure and Algorithms', icon: Code, desc: 'Advanced data structures, algorithm analysis, and problem-solving techniques.' },
      ...
      4: [
        { code: 'CS1105', name: 'Design and Analysis of Algorithms', icon: Code, desc: 'Algorithm design paradigms, complexity classes, and advanced graph algorithms.' },
  ...
  year3: {
    ...
    branches: {
      core: [
        { code: 'CS1101', name: 'Object Oriented Programming', icon: Code, desc: 'Classes, objects, inheritance, polymorphism, and Java fundamentals.' },
