        ...
        <ul className="footer-admins-list" style={{ display: 'flex', flexDirection: 'row', flexWrap: 'wrap', gap: '20px', justifyContent: 'center' }}>
          <li style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '4px' }}>
            ...
            <div style={{ display: 'flex', gap: '10px', marginTop: '4px' }}>
              <a href="https://wa.me/917737472264" target="_blank" rel="noopener noreferrer" style={{ display: 'inline-flex', alignItems: 'center', gap: '4px', fontSize: '0.75rem', color: '#25D366', textDecoration: 'none', background: 'rgba(37, 211, 102, 0.1)', padding: '4px 8px', borderRadius: '12px', transition: 'all 0.2s', fontWeight: 'bold' }}>
